---
title: "Introduction to the kmer package"
...
## Introduction
Traditional clustering methods based on multiple sequence alignments, pairwise
distance matrices, and agglomerative (bottom-up) tree-building methods are often 
computationally infeasible for large, high-throughput DNA and RNA datasets.
...
The matrix of kmer counts can then be used in place of a multiple sequence alignment to 
...
```{r, out.width='700px', out.height='450px', dpi=500}
...
### convert to dendrogram and plot
tree1 <- phylogram::as.dendrogram(tree1)
plot(tree1, horiz = TRUE, yaxt = "n", 
...
### convert to dendrogram and plot
tree2 <- phylogram::as.dendrogram(tree2)
plot(tree2, horiz = TRUE, yaxt = "n", 
...
##Concluding remarks
The **kmer** package is released under the GPL-3 license, and is free to distribute
